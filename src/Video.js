				...
				{this.state.askForUsername === true ?
					<div>
						<div style={{
							...
							<p style={{ margin: 0, fontWeight: "bold", }}>Set your nickname here.</p>
							<p style={{ margin: 0, fontSize: "12px" }}>This will be your name visible to other participants.</p>
						...
						<div style={{ justifyContent: "center", textAlign: "center", paddingTop: "40px" }}>
							<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
								...
								borderColor: "#ff0000", objectFit: "fill", width: "60%", height: "30%"
							}}></video>
						</div>
					</div>
					:
					<div>
						...
						<div className="container">
							...
							<Row id="main" className="flex-container" style={{ margin: 0, padding: 0 }}>
								<video id="my-video" ref={this.localVideoref} autoPlay muted style={{
									borderStyle: "solid", borderColor: "#ff0000", margin: "10px", objectFit: "fill",
									transform: "rotateY(180deg)", width: "100%", height: "100%"
								}}></video>
							</Row>
						</div>
					</div>
